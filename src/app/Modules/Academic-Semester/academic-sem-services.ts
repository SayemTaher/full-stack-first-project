...
const updateSingleDataInDb = async (id: string, payload: Partial<TAcademicSemester>) => {
    type TAcademicSemesterCode = {
      [key: string]: string;
    };
    ...
    const data = await AcademicSemister.findOneAndUpdate({ _id: id }, payload, { new: true });
    return data
}


export const AcademicSemesterServices = {
    createAcademicSemesterInDb,getAllAcademicSemesterFromDb, getSingleSemesterDataFromDb,updateSingleDataInDb
}